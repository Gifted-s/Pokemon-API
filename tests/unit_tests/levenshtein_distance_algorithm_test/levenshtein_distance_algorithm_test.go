package levenshtein_distance_algorithm_test
...
func Test_Levenshtein_Distance_Algorithm(t *testing.T) {
	assert := assert.New(t)
	editDistance := helpers.MinDistance("bola", "bulbasaur")
...
func Test_Levenshtein_Distance_Algorithm_With_Two_Identical_Strings(t *testing.T) {
	assert := assert.New(t)
	editDistance := helpers.MinDistance("Metapod", "Metapod")
...
func Test_Levenshtein_Distance_Algorithm_With_Empty_String1(t *testing.T) {
	assert := assert.New(t)
	editDistance := helpers.MinDistance("", "bulbasaur")
...
func Test_Levenshtein_Distance_Algorithm_With_Two_Empty_Strings(t *testing.T) {
	assert := assert.New(t)
	editDistance := helpers.MinDistance("", "")
